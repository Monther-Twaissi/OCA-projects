				...
				<div class="login_form_inner">
					...
					<form class="row login_form" method="POST" action="#/" id="contactForm">
						<div class="col-md-12 form-group">
							<input type="email" class="form-control" id="name" name="email" placeholder="email" onfocus="this.placeholder = ''" value="<?php echo $email; ?>" onblur="this.placeholder = 'Email'"><span style="color: red;" class="error "><?php echo $emailErr; ?></span>
						</div>
						<div class="col-md-12 form-group">
							<input type="password" class="form-control" id="name" name="password" placeholder="Password" onfocus="this.placeholder = ''" value="<?php echo $password; ?>" onblur="this.placeholder = 'Password'"><span style="color: red;" class="error "> <?php echo $passwordErr; ?></span>
						</div>
						<!-- <div class="col-md-12 form-group">
							</div> -->
						<div class="col-md-12 form-group">
